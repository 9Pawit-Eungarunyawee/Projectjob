...
export default function AddProduct() {
  ...
  const handleForm = async (event) => {
    ...
    if (result) {
      setAlert(<Alert severity="success">เพิ่มข้อมูลสำเร็จ</Alert>);
    } else {
      setAlert(
        <Alert severity="error">ผิดพลาด! ไม่สามารถเพิ่มข้อมูลได้</Alert>
      );
    }
  };
  return (
          ...
          <form onSubmit={handleForm} className="form">
            <FormControl fullWidth>
              ...
              >
                ...
                <MenuItem value={"เกรดมาตรฐานบน 5-7 ปี"}>เกรดมาตรฐานบน 5-7 ปี</MenuItem>
                <MenuItem value={"เกรดมาตรฐาน 3-5 ปี"}>เกรดมาตรฐาน 3-5 ปี</MenuItem>
                <MenuItem value={"เกรดประหยัด 1-3 ปี"}>เกรดประหยัด 1-3 ปี</MenuItem>
              </TextField>
